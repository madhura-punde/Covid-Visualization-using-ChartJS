...
function Info() {
  return (
    <div>
    <div  className='customeclass1'>
      <h5>Coronavirus disease (COVID-19) is an infectious disease caused by the SARS-CoV-2 virus.</h5>

      <p>Most people infected with the virus will experience mild to moderate 
      ...
      are more likely to develop serious illness. Anyone can 
      get sick with COVID-19 and become seriously ill or die at any age. </p>

      <p>The best way to prevent and slow down transmission is to be well 
      ...
      follow local guidance.</p>
      <p>The virus can spread from an infected person’s mouth or nose in 
